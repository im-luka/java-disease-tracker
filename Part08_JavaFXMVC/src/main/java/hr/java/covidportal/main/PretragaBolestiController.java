...
public class PretragaBolestiController implements Initializable {
    ...
    private static ObservableList<Bolest> observableListaSamoBolesti;

    public static ObservableList<Bolest> getObservableListaSamoBolesti() {
        return observableListaSamoBolesti;
    }

    public static void setObservableListaSamoBolesti(ObservableList<Bolest> observableListaSamoBolesti) {
        PretragaBolestiController.observableListaSamoBolesti = observableListaSamoBolesti;
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        observableListaSamoBolesti = FXCollections.observableArrayList(samoBolestiLista);

        tablicaBolesti.setItems(observableListaSamoBolesti);
    }
