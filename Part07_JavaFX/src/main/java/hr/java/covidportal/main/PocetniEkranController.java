...
public class PocetniEkranController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(PretragaZupanijaController.getObservableListaZupanija() == null){
            ...
            citanjeDatotekeZupanije(zupanijeLista);
        ...
        if(PretragaSimptomaController.getObservableListaSimptoma() == null){
            ...
            citanjeDatotekeSimptomi(simptomiLista);
            PretragaSimptomaController.setObservableListaSimptoma(FXCollections.observableArrayList(simptomiLista));
        }

        if(PretragaBolestiController.getObservableListaBolesti() == null){
            List<Bolest> bolestiLista = new ArrayList<>();
            citanjeDatotekeBolesti(PretragaSimptomaController.getObservableListaSimptoma(), bolestiLista);
            PretragaBolestiController.setObservableListaBolesti(FXCollections.observableArrayList(bolestiLista));
        }

        if(PretragaVirusaController.getObservableListaVirusa() == null){
            List<Virus> virusiLista = new ArrayList<>();
            citanjeDatotekeVirusi(PretragaSimptomaController.getObservableListaSimptoma(), PretragaBolestiController.getObservableListaBolesti(), virusiLista);
        ...
        if(PretragaOsobaController.getObservableListaOsoba() == null){
            ...
            citanjeDatotekeOsobe(PretragaZupanijaController.getObservableListaZupanija(), PretragaBolestiController.getObservableListaBolesti(), osobeLista);
    ...
    public static void citanjeDatotekeBolesti(List<Simptom> simptomiLista, List<Bolest> bolestiLista) {
            ...
            BufferedReader reader = new BufferedReader(bolReader))
        {
            ...
            while ((procitanaLinija = reader.readLine()) != null){
                ...
                Bolest bol = new Bolest(id, naziv, listaPomoc);
    ...
    public static void citanjeDatotekeVirusi(List<Simptom> simptomiLista, List<Bolest> bolestiLista, List<Virus> virusiLista) {
            ...
            BufferedReader reader = new BufferedReader(virReader))
        {
            ...
            while ((procitanaLinija = reader.readLine()) != null){
                ...
                Virus vir = new Virus((long)id, naziv, listaPomoc);
                Virus virV = new Virus(idV, naziv, listaPomoc);
