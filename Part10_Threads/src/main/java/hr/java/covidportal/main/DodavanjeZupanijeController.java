...
import main.java.hr.java.covidportal.niti.ZupanijeDodajNit;
...
public class DodavanjeZupanijeController implements Initializable {
    ...
    /**
     * Služi za dodavanje nove županije preko korisničkog sučelja aplikacije u tablicu i bazu podataka.
     *
     * @throws IOException
     */
    public void dodajZupaniju() throws IOException {
        try{
            ...
            Integer velicina = BazaPodataka.dohvatiZupanije().size() + 1;
            ...
            servis.execute(new ZupanijeDodajNit(zup));
    ...
    /**
     * Služi za povratak na početni ekran za pretragu županija.
     *
     * @throws IOException
     */
