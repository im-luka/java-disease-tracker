...
public class BazaPodataka {
    ...
    private static boolean aktivnaVezaSaBazomPodataka = false;

    private static boolean aktivnaVezaZaDohvatInstanci = false;

    public static boolean isAktivnaVezaSaBazomPodataka() {
        return aktivnaVezaSaBazomPodataka;
    }

    public static void setAktivnaVezaSaBazomPodataka(boolean aktivnaVezaSaBazomPodataka) {
        BazaPodataka.aktivnaVezaSaBazomPodataka = aktivnaVezaSaBazomPodataka;
    }

    public static boolean isAktivnaVezaZaDohvatInstanci() {
        return aktivnaVezaZaDohvatInstanci;
    }

    public static void setAktivnaVezaZaDohvatInstanci(boolean aktivnaVezaZaDohvatInstanci) {
        BazaPodataka.aktivnaVezaZaDohvatInstanci = aktivnaVezaZaDohvatInstanci;
    }
     ...
     * @throws IOException
     */
    public static synchronized Connection povezivanjeSaBazomPodataka() throws SQLException, IOException {
     ...
     * @throws IOException
     */
    public static List<Bolest> dohvatiBolestVirus() throws SQLException, IOException {
