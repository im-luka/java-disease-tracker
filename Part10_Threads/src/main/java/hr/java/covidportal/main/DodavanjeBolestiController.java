...
public class DodavanjeBolestiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            tablicaSimptomaBolesti.setItems(FXCollections.observableArrayList(BazaPodataka.dohvatiSimptome()));
        } catch (SQLException | IOException iznimka) {
            iznimka.printStackTrace();
            PocetniEkranController.logger.error("Greška prilikom dohvata podataka o simptomima iz baze podataka kod dodavanja bolesti! ", iznimka);
        }
     ...
     */
    public static void provjeraSimptoma(List<Simptom> pomocnaListaSimptoma) throws BolestIstihSimptoma, IOException, SQLException {
        List<Bolest> pomocnaListaBolesti = BazaPodataka.dohvatiBolestVirus();
        int brojac = 0;
